...
\resumeSubHeadingListStart
\resumeSubheading{Neurobiology of Aging Laboratory}{Dra. Cheril Tapia-Rojas, Ph. D.}{Universidad San Sebastián; Santiago, Chile}{Mayo 2023 - a la fecha}
\vspace{2pt}
\small{
	\begin{itemize}
		\item Conducted extensive bioinformatic analysis as part of a study investigating
			the correlation between mitochondrial protease Lonp1 and age-associated
